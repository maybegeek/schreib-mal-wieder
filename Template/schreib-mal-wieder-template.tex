...
\newcommand{\pstFormatBreit}{\dezimalxmaspar{\fontsize{5}{6}\selectfont$if(PstLang)${\text$PstLang${\pstDerText}}$else$\pstDerText$endif$}}
...
\newcommand{\pstFormatBreitFarbe}{\dezimalxmaspar{\fontsize{5}{6}\selectfont\textcolor{TEXTFARBE}$if(PstLang)${\text$PstLang${\pstDerText}}$else$\pstDerText$endif$}}
\renewcommand{\pstZusatzA}{$if(PstZusatzA)$$PstZusatzA$$else$Frohe Weihnachten$endif$}
\renewcommand{\pstZusatzB}{$if(PstZusatzB)$$PstZusatzB$$else$$endif$}
}{}
